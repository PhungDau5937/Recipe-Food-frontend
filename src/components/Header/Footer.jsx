    ...
    <footer className="font-sans tracking-wide bg-white px-10 pt-12 pb-6">
        ...
        <div className="max-w-md">
          ...
          <div className="mt-6">
            <p className="text-gray-600 leading-relaxed text-sm">
              Discover delicious recipes, cooking tips, and culinary
              inspiration. Join our food-loving community and elevate your
              kitchen adventures today!
            </p>
          </div>
      ...
      <div className="flex flex-wrap max-md:flex-col gap-4">
        ...
        <p className="text-gray-600 text-sm md:ml-auto">
          © 2024. Pham Ngoc Phung Developer.
        </p>
      </div>
    </footer>
  );
